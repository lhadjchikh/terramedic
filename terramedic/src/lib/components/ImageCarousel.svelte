...
<div class="carousel relative h-96 w-full overflow-hidden rounded-lg bg-gray-100 md:h-[32rem]">
	...
	<!-- Navigation Buttons -->
	<button
		class="absolute left-8 top-1/2 -translate-y-1/2 transform rounded-full bg-white p-2 text-black shadow-md"
		on:click={prevImage}
	>
		&#8592;
	</button>
	<button
		class="absolute right-0 top-1/2 -translate-y-1/2 transform rounded-full bg-white p-2 text-black shadow-md"
		on:click={nextImage}
	>
		&#8594;
	</button>
